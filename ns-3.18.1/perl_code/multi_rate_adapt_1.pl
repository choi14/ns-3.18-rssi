...
$output_filename="results_log1/"."Result_4.txt";
open(OUT4, ">$output_filename") ||die "Failed opening.\n";
$output_filename="results_log1/"."Result_5.txt";
open(OUT5, ">$output_filename") ||die "Failed opening.\n";
$output_filename="results_log1/"."Result_6.txt";
open(OUT6, ">$output_filename") ||die "Failed opening.\n";
$output_filename="results_log1/"."Result_7.txt";
open(OUT7, ">$output_filename") ||die "Failed opening.\n";
$output_filename="results_log1/"."Result_8.txt";
open(OUT8, ">$output_filename") ||die "Failed opening.\n";
$output_filename="results_log1/"."Result_9.txt";
open(OUT9, ">$output_filename") ||die "Failed opening.\n";
$output_filename="results_log1/"."Result_10.txt";
open(OUT10, ">$output_filename") ||die "Failed opening.\n";
$output_filename="results_log1/"."Result_11.txt";
open(OUT11, ">$output_filename") ||die "Failed opening.\n";

for ($id=0; $id <18; $id++){
  $input_filename="log1/"."log_"."$id".".txt";

...
void //jychoi
WifiMacHeader::SetFeedback (void)
{
	m_ctrlType = TYPE_MGT;
	m_ctrlSubtype = 6;
}
...
WifiMacHeader::SetType (enum WifiMacType type)
{
  switch (type)
    ...
    case WIFI_MAC_MGT_PROBE_RESPONSE:
      ...
      m_ctrlSubtype = 5;
      break;
		case WIFI_MAC_MGT_FEEDBACK: //jychoi
			m_ctrlType = TYPE_MGT;
			m_ctrlSubtype = 6;
			break;
...
bool //jychoi
WifiMacHeader::IsFeedback (void) const
{
	return (m_ctrlType == TYPE_MGT && (m_ctrlSubtype & 0x06));
}
bool
